...
# Question 1
# TODO
centroid_3 = tf_idf[0:3,:]
# print(centroid_3.shape)
distances = pairwise_distances(tf_idf, centroid_3, metric='euclidean')
...
def assign_clusters(data, centroids):
    ...
    closest_centroid_index = np.argmin(distance, axis=1)
...
# # Question 6
# # TODO
# print(q5_cluster_assignment.shape)
largest_cluster = np.bincount(q5_cluster_assignment).argmax()
largest_cluster
...
def kmeans_multiple_runs(data, k, max_iter, seeds, verbose=False):
    ...
    for seed in seeds:
        ...
        centroids, cluster_assignment = kmeans(data, k, initial_centroids, max_iter, record_heterogeneity=None, verbose=True)
...
cluster = {}
# print(q8_cluster_assignment)
for c in range(100):
    cluster.update({c : (q8_cluster_assignment == c).sum()})
